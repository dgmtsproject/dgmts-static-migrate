      ...
      sections: [
        {
          ...
          items: [
            {
              name: "Company History and Mission",
              path: "/about",
              icon: Users,
          ...
          items: [
            {
              ...
              path: "/blog",
              icon: Newspaper,
              description: "Technical insights and guides",
            },
            {
              name: "Published Papers",
              path: "/published-papers",
              icon: Library,
              description: "Contributions to the research community",
            },
            {
      ...
      sections: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              path: "/services/construction-inspection-testing",
              icon: Construction,
              description: "Quality assurance for construction projects",
            },
            {
              name: "Laboratory Testing",
              path: "/services/laboratory-testing",
              icon: FlaskConical,
              description: "Advanced material testing capabilities",
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              path: "/services/drilling-in-situ-testing",
              icon: Drill,
              description: "Field testing and drilling services",
            },
            {
              name: "Instrumentation & Surveys",
              path: "/services/instrumentation-condition-surveys",
              icon: Radar,
              description: "Monitoring and condition assessment",
            },
          ],
        },
      ],
        ...
        <div className="mega-menu-inner">
          ...
          <div className="desktop-nav">
            ...
            {Object.entries(megaMenuData).map(([key, menu]) => (
              ...
              >
                <button
                  className={`mega-menu-button ${activeMegaMenu === key ? "active" : ""}`}
                >
            ...
            <Link to="/it-services" className="desktop-nav-link">
              IT & Digital Services
            </Link>
            <Link to="/geo5-software" className="desktop-nav-link">
              GEO5 Software
            </Link>
            ...
            <Link to="/clients" className="desktop-nav-link">
              Our Clients
            </Link>
