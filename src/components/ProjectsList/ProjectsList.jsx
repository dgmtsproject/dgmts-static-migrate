...
import projectsData from '../../pages/ProjectsPage/data.json';
      ...
      <div className="projects-list-container">
        ...
        <div className="projects-list-grid">
          {projects.map((project, index) => {
            const fullProject = projectsData.projects.find(p => p.title === project.title);
            ...
            const projectItem = (
              <div key={index} className="project-list-item">
                ...
                <div className="project-list-content">
                  <h4 className="project-list-item-title">{displayTitle}</h4>
