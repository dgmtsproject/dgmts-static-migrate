  ...
  <main className="about-page bg-texture">
    <section className="about-section who-we-are">
      ...
      <div className="about-content">
        <p>Established in 2012, <strong>Dulles Geotechnical and Materials Testing Services, Inc. (DGMTS)</strong> is a SWaM, MBE and DBE certified firm that offers a wide range of engineering services including geotechnical engineering and QA/QC testing to both the private sector and public agencies.</p>
        <p>Our diverse team of geotechnical engineers, geoscientists, geologists, structural engineers, project managers, construction engineers and inspectors, technicians, designers and IT administrative support staff who offer a multidisciplinary approach to our engineering consulting and site services. Our team of certified engineers, highly trained inspectors and field technicians have the experience and expertise to take on any project of any size, large or small.</p>
        <p>In addition to a dedicated team, DGMTS provides independent construction materials testing at our two in-house testing laboratory facilities in Chantilly and Hampton. We are able to set up additional laboratories on project sites, ensuring efficiency and providing flexibility for our clients. Our laboratories are accredited by the American Association of State Highway and Transportation Officials (AASHTO) and we are members of the Washington Area Council of Engineering Laboratories, Inc. (WACEL). Our accreditation conforms to the requirements of ASTM D3740, ASTM E329, and AASHTO R-18.</p>
        <p>On top of our dedicated team and state of the art laboratories, DGMTS owns a fleet of truck mounted drill rigs with capability of hollow-stem auger, mud rotary and rock coring. Our support equipment consists of service trucks, trailers, light towers, generators, and welding equipment. We also have asphalt and concrete coring machine to meet our clients&apos; wide range of needs anywhere in the region.</p>
      </div>
    </section>
