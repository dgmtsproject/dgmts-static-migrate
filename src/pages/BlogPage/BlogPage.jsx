...
function BlogPage() {
  ...
  const applyFilters = useCallback(() => {
    ...
    if (selectedCategory) {
      filtered = filtered.filter(
        (blog) => blog.category && blog.category === selectedCategory,
      );
    }
    ...
    <div className="blog-page bg-texture">
      <div className="container">
        <header className="blog-header">
          ...
          <p>
            Stay updated with the latest news, insights, and technical articles
            from our team.
          </p>
        </header>
          ...
          <form className="newsletter-form" onSubmit={handleNewsletterSubmit}>
            <div className="form-group">
              <input
                ...
                onChange={(e) =>
                  setNewsletterData({ ...newsletterData, name: e.target.value })
                }
                required
              />
              <input
